...
function main() {
  ...
  console.log("      $ agentools init\n");
  console.log("   2. Install bundled skills to platforms:");
  console.log("      $ agentools install\n");
  console.log("   3. (Optional) Add more skills from GitHub:");
  console.log("      $ agentools source add <repo-url>\n");
  console.log("   4. Update & install additional skills:");
  console.log("      $ agentools update && agentools install\n");
  console.log("📦 Repository: https://github.com/dongitran/agentools\n");
